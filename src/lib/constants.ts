...
export const NBA_PLAYERS: Record<string, string[]> = {
  ...
  'CLE': ['Donovan Mitchell', 'Evan Mobley', 'Jarrett Allen', "La barba", "Max Strus", "Dennis Schroder"],
  ...
  'NYK': ['Jalen Brunson', 'Josh Hart', 'Donte DiVincenzo', "Karl-Anthony Towns", "Julius Randle", "OG Anunoby", "RJ Barrett", "Mitchell Robinson"],
  'OKC': ['Shai Gilgeous-Alexander', 'Chet Holmgren', 'Jalen Williams', "Luguentz Dort", "Ajay Mitchell", "Isaiah Hartenstein", "Alex Caruso"],
  ...
  'SAS': ['Victor Wembanyama', "Devin Vassell", "Keldon Johnson", "Stephon Castle", "DeAaron Fox", "Dylan Harper", "Julian Champagnie"],
  'TOR': ['Scottie Barnes'],
  'UTA': ['Lauri Markkanen'],
  'WAS': ['Kyle Kuzma'],
};
